...
class TextToSQLAgent:
    ...
    def generate_sql(self, question, previous_sql=None, sql_error=None):
        ...
        # Give Gemini a few chances if the model is temporarily unavailable
        ...
        for attempt in range(max_gemini_retries + 1):
            ...
            try:
                ...
                # If the request succeeds, stop retrying
                break


            except errors.ClientError as error:

                # 429 means the API quota or rate limit has been reached
                ...
                if getattr(error, "code", None) == 503:
                    ...
                    if attempt == max_gemini_retries:
                        ...
                        raise RuntimeError(
                            ...
                            "after multiple retries. Please try again later."
                        ) from error
                ...
                # Re-raise any other server error
                raise
